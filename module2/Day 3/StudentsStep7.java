...
public class StudentsStep7 {
    ...
    public static void main(String[] args) {
        ...
        //Ask if the user wants to print the list or just one student
        //The question is included in a while loop so the user can take as many actions as he wants
        //If the user enters something different from "a" or "b", then we exit the loop
        String userOption = "a";
        while (userOption.equals("a") || userOption.equals("b")) {
            System.out.println();
            System.out.print("Do you want to (a) see the list of students or (b) search for one student? ");
     ...
     * It will request the student name from the user, then it will loop through the list until the student is found.
