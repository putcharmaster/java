...
public class StudentsStep4 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= studentsAmount; i++) {
            ...
            registeredStudents += firstName + " " + lastName + ", ";
            registeredStudents += birthDay + " " + birthMonthName + " " + birthYear + ", ";
            registeredStudents += courseRegistered + "\n";
        }
